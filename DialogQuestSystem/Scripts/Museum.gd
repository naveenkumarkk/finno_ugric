...
func _build_ui(vp: Vector2):
	...
	var title := Label.new()
	title.text = "Soome-ugri pärandi muuseum"
	...
	subtitle.text = "Liigu eseme juurde ja vajuta vaatamiseks [E]"
...
func _on_exit_pressed():
	if OS.get_name() == "Web":
		...
		var lbl := Label.new()
		lbl.text = "Täname mängimast!\n\nSoome-ugri pärandi ekspeditsioon"
